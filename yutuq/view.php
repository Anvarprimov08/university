                      ...
                      <?
                        ...
                        while ($row=mysql_fetch_assoc($doc)): $i++; ?>
                          <tr>
                            ...
                            <td><?=$row['name']?></td>
                            <td>
                              <button type="button" onclick="if(confirm('Fakultet nomini o\'zgartirmoqchimisiz'))window.location.href='edit.php?id=<?=$row[id]?>'" class="btn btn-primary btn-icon-text"><i class="fa fa-edit btn-icon-prepend">  Nomini tahrirlash</i></button>&nbsp;&nbsp;&nbsp;
                              <button type="button" onclick="if(confirm('Fakultetni o\'chirish ma\'lumotlar bilan muammoga olib keladi'))window.location.href='view.php?del=<?=$row[id]?>'" class="btn btn-outline-primary btn-icon-text"><i class="fas fa-trash btn-icon-prepend">  O'chirish</i></button>
                            </td>
                          </tr>
                      <? endwhile; ?>
                    </tbody>
