...
<body class="sidebar-fixed">
  <div class="container-scroller">
    ...
    <?   
      ...
      $surov=mysql_query("SELECT * from imtiyoz where id='$id'");
    ...
    <?   
      if (isset($_POST['ok'])) {
        ...
        if (mysql_num_rows($test)==0 or $row['name']==$nam) {
          $i++;
        } else {
          $ertest="Ushbu NOM avval ro'yxatdan o'tgan iltimos qaytadan urinib ko'ring!";
        }
        if ($i==2) {
          $surov=mysql_query("UPDATE imtiyoz set name='$name' where id='$id'");
          if ($surov) {
            print("<script>window.alert('Imtiyoz nomi muvaffaqiyatli o\'zgartirildi!!!')</script>");
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
              Imtiyozlarning nomini tahrirlang
            </h3>
          </div>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="">Imtiyoz nomini to'g'ri kiriting</h5>
                  <p style="color: red;"><?=$ertest?></p>
                  <form class="cmxform" id="signupForm" method="post">
                    <fieldset>
                      <div class="form-group">
                        <label for="name"> Imtiyoz nomi</label>
