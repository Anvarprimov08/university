  ...
  <div class="container-scroller">
    ...
    <?
      if (isset($_POST['ok'])) {          
        ...
        if ($i==7) {
          $surov=mysql_query("INSERT into user(fam, ism, sharif, tel, login, parol, rol, fak_id) values('$fam', '$ism', '$sharif', '$tel', '$login', '$parol', 'admin', '0')");
          if ($surov) {
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
              Nazoratchi siz bilan teng huquqga ega bo'ladi.
            </h3>
          </div>
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="">Nazoratchi qo'shish</h5>
