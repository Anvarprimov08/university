      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
              Fakultetni tanlang va talabalarning mu'lumotlarni saralash orqali oling
            </h3>
          </div>
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="tuman_id" >
                              <option value="0">--Kerak emas--</option>
                              <?
                                $surov5=mysql_query("SELECT * from tuman where vid='9' order by name asc");
                                $m=0;
                                while ($row5=mysql_fetch_assoc($surov5)){
                                  if ($_POST['tuman_id']==$row5['id']) {
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" name="imtiyoz_id" >
                              <option value="0">--Kerak emas--</option>
                              <?
                                $surov1=mysql_query("SELECT * from imtiyoz order by name asc");
                                $m=0;
                                while ($row1=mysql_fetch_assoc($surov1)){
                                  if ($_POST['imtiyoz_id']==$row1['id']) {
                                    print("<option selected value='$row1[id]'>$row1[name]</option>");
                                  } else{
                                    print("<option value='$row1[id]'>$row1[name]</option>");
                                  }
          ...
          <?php if ($_POST['fak_id']>0 and ($_POST['turar_joy'] or $_POST['yetimlik'] or $_POST['temir_daftar'] or $_POST['nogiron'] or $_POST['oilaviy'] or $_POST['vil_id'] or $_POST['tuman_id'] or $_POST['imtiyoz_id'] or $_POST['yutuq_id'])):
            $sql="fak_id='$fak_id'";
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="display-5">
                      ...
                      <!-- excelga yuklash -->
                      <form method="post" action="excel_upload_by_sort_by_admin.php" style="float: right">
                        <?
                          $_SESSION['fakultet']=$fak_id;
                          $_SESSION['turar_joy']=$turar_joy;
                          $_SESSION['nogiron']=$nogiron;
                          $_SESSION['sql']=$sql;
                        ?>
                        <button type="submit" class="btn btn-danger btn-lg" name="excel_upload_admin"><i class="fas fa-cloud-upload-alt"></i> Yuklash</button>
                      </form>
                    </h4>
