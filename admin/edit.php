...
<body class="sidebar-fixed">
  <div class="container-scroller">
    ...
    <?   
      ...
      $surov=mysql_query("SELECT * from tuman where id='$id'");
    ...
    <?   
      if (isset($_POST['ok'])) {
        ...
        if (preg_match("/^[a-z`'ʼ ]{3,}$/i", $nam)) {
          ...
          $ername="3 ta belgidan kam bo'lmagan NOM kiriting";
        }
        $test=mysql_query("SELECT * from tuman where name='$name' and vid='$vid'");
        if (mysql_num_rows($test)==0 or $row['name']==$nam and $row['vid']==$vid) {
          $i++;
        } else {
          $ertest="Ushbu NOM avval ro'yxatdan o'tgan iltimos qaytadan urinib ko'ring!";
        }
        if ($i==2) {
          $surov=mysql_query("UPDATE tuman set name='$name' where id='$id'");
          if ($surov) {
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title">
              Tumanlarning nomini tahrirlang
            </h3>
          </div>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h5 class="">Tuman nomini to'g'ri kiriting</h5>
